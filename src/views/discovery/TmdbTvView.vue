...
const FILTERS: Record<string, FilterField> = {
  with_genres: {
    name: '类型',
    options: [
      { label: '全部', value: '' }, { label: '动作冒险', value: '10759' },
      { label: '动画', value: '16' }, { label: '喜剧', value: '35' },
      { label: '犯罪', value: '80' }, { label: '纪录', value: '99' },
      { label: '剧情', value: '18' }, { label: '儿童', value: '10762' },
      { label: '悬疑', value: '9648' }, { label: '真人秀', value: '10764' },
...
const cfgRef = computed<TypeConfig>(() => ({ type: 'DISCOVER', subtype: 'TV', title: 'TMDB剧集' }))
